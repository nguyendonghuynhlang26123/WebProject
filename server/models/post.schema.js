...
const PostSchema = new Schema({
  ...
  post_category: { type: Schema.Types.ObjectId, ref: "categories", default: null },
  post_content: { type: String, default: null },
  ...
  post_status: { type: String, enum: ["Published", "Draft", "Trash"], default: "Draft" },
});
